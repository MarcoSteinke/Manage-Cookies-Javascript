...
I do not own this code. The code was first shown in https://howchoo.com/javascript/how-to-manage-cookies-in-javascript[this article]. I did only want to give it some attention by adding it on github!
